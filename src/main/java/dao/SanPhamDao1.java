...
public class SanPhamDao1 {
    public static boolean insertSanPham(SanPham sanPham, String maBalo){
        String sql = "insert into sanpham1(ma,ten,trongLuong,giaTri,donGia,phuongAn,maBalo) values (?,?,?,?,?,null,?)";
        try {
            ...
            PhuongAnDao1.addPhuongAnThamAn(sanPham.getMa());
    ...
    public static SanPham findById(String maSanPham){
        String sql = "select ma,ten,trongLuong,giaTri from sanpham1 where ma = ?";
        try {
            Connection con  = DatabaseHelper.openConnection();
            PreparedStatement pstmt = con.prepareStatement(sql);
    ...
    public static boolean searchByID(String maBalo){
        String sql = "select ma from balo1 where ma = ?";
        try {
            Connection con = DatabaseHelper.openConnection();
            PreparedStatement pstmt = con.prepareStatement(sql);
    ...
    public static List<SanPham> findAll(){
        String sql = "select ma,ten,trongLuong,giaTri,phuongAn from sanpham1";
        try {
            Connection con  = DatabaseHelper.openConnection();
            PreparedStatement pstmt = con.prepareStatement(sql);
            ResultSet rs  = pstmt.executeQuery();
    ...
    public static List<SanPham> findByIdBalo(String maBalo){
        String sql = "select ma,ten,trongLuong,giaTri,donGia,phuongAn from sanpham1 where maBalo = ? ORDER BY CAST(SUBSTRING_INDEX(ma, '_', -1) AS SIGNED) ASC";
        try {
            Connection con = DatabaseHelper.openConnection();
            PreparedStatement pstmt = con.prepareStatement(sql);
            pstmt.setString(1, maBalo);
    ...
    public static boolean deleteById(String maSanPham){
        String sql = "delete from sanpham1 where ma = ? ";
        try {
            Connection con  = DatabaseHelper.openConnection();
            PreparedStatement pstmt = con.prepareStatement(sql);
            pstmt.setString(1, maSanPham);
    ...
    public static boolean UpdateSanPham(SanPham sp){
        String sql = "UPDATE sanpham1  SET ten = ?, trongLuong = ?, giaTri = ?, phuongAn = ? WHERE ma = ?";
        try {
            Connection con = DatabaseHelper.openConnection();
            PreparedStatement pstmt = con.prepareStatement(sql);
    ...
    public static boolean UpdateSanPham1(SanPham sp){
        String sql = "UPDATE sanpham1  SET ten = ?, trongLuong = ?, giaTri = ?, donGia=? WHERE ma = ?";
        try {
            Connection con = DatabaseHelper.openConnection();
            PreparedStatement pstmt = con.prepareStatement(sql);
            pstmt.setString(1, sp.getTen());
    ...
    public static List<SanPham> LocSanPham(String maBalo){
        String sql = "select ma,ten,trongLuong,giaTri,phuongAn from sanpham1 where maBalo = ? and phuongAn<>0 ORDER BY CAST(SUBSTRING_INDEX(ma, '_', -1) AS SIGNED) ASC";
        try {
            Connection con  = DatabaseHelper.openConnection();
            PreparedStatement pstmt = con.prepareStatement(sql);
            pstmt.setString(1, maBalo);
    ...
    public static boolean findSanPhamByID(String ma){
        String sql = "select * from sanpham1 where ma = ?";
        try {
            Connection con = DatabaseHelper.openConnection();
            PreparedStatement pstmt = con.prepareStatement(sql);
