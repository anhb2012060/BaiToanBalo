...
public class XuatFile2 {
    ...
    public static void exportToTxt(List<SanPham> sanPhamList, List<SanPham> sanPhamListTA, List<SanPham> sanPhamListNC, List<SanPham> sanPhamListQHD, String duongDanVaTenFile, String trongLuongBalo) {
        try {
            ...
            bw.newLine();
            bw.newLine();
            printThamAn(bw, sanPhamListTA);
            printNhanhCan(bw, sanPhamListNC);
            printQuyHoachDong(bw, sanPhamListQHD);
            bw.write("""
                                                           HẾT
                     """);
            bw.close();
    ...
    public static void printQuyHoachDong(BufferedWriter bw, List<SanPham> sanPhamList) throws IOException {
        bw.write("""
                    ******************************QUY HOẠCH ĐỘNG******************************
                             """);
        bw.newLine();
        ...
        for (SanPham sanPham : sanPhamList) {
            ...
            String soLuong = String.format("%-10s", sanPham.getSoLuong());
    ...
    public static void printNhanhCan(BufferedWriter bw, List<SanPham> sanPhamList) throws IOException {
        bw.write("""
                    ********************************NHÁNH CẬN********************************
                             """);
        bw.newLine();
    ...
    public static void printThamAn(BufferedWriter bw, List<SanPham> sanPhamList) throws IOException {
        bw.write("""
                    ********************************THAM ĂN********************************
                         """);
        bw.newLine();
    ...
    public static void printAll(BufferedWriter bw, List<SanPham> sanPhamList) throws IOException {
        bw.write("""
