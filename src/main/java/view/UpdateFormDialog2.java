 ...
 * @author OS
 */
public class UpdateFormDialog2 extends javax.swing.JDialog {

    private Balo2Form balo2Form;

    // Trong UpdateFormDialog
    public UpdateFormDialog2(java.awt.Frame parent, boolean modal, Balo2Form balo2Form) {
        super(parent, modal);
        initComponents();
        this.balo2Form = balo2Form;
        UpdateSanPhamForm();
    }
    ...
    private void jButton_CapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_CapNhatActionPerformed
        try {
            ...
            if(SanPhamDao2.UpdateSanPham1(sp)){
                ...
                balo2Form.loadDataToTable(); // Gọi phương thức loadDataToTable để cập nhật dữ liệu trong bảng
                balo2Form.taoMoiForm();
