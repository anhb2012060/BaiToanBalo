...
import algorithm.XuatFile2;
import dao.BaloDao1;
import dao.BaloDao2;
import dao.PhuongAnDao2;
 ...
 * @author OS
 */
public class Balo2Form extends javax.swing.JPanel {
    private DefaultTableModel tblModel;
    private MainView mainView;
    private boolean textFieldHasData = false;
    private UpdateFormDialog2 updateFormDialog;
    ...
    public void loadDataToTable(){
        try {
            List<SanPham> list = SanPhamDao2.findByIdBalo(jTextField_MaBalo.getText());
            tblModel.setRowCount(0);
            
            Balo balo = BaloDao2.findById(jTextField_MaBalo.getText());
...
//========================================================================================================================================== 
    ...
    private void initComponents() {
        ...
        jPanel_themFileLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_themFileLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_themFileLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void jButton_ThemMoiBaloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ThemMoiBaloActionPerformed
        ...
        if(SanPhamDao2.searchByID(jTextField_MaBalo.getText())){
    ...
    private void jButton_ThêmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ThêmActionPerformed
        ...
        if(SanPhamDao2.findSanPhamByID(jTextField_MaBalo.getText()+"_"+jTextField_SoThuTu.getText())){
        ...
        try {
            ...
            sanpham.setSoLuong(Integer.parseInt(jTextField_SoLuong.getText()));
            String maBalo = jTextField_MaBalo.getText();
            
            if(SanPhamDao2.insertSanPham(sanpham, maBalo)){
                MessageDialogHelper.showMessageDialog(mainView, "Thêm sản phẩm thành công", "Thông báo");
                BaloDao2.updateSttBalo(jTextField_MaBalo.getText(), soThuTu);
                jButton_TaoMoiActionPerformed(evt);
                jTextField_SoThuTu.setText(soThuTu+"");
                loadDataToTable();
            } else {
    ...
    private void jButton_TimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_TimKiemActionPerformed
        ...
        try {
            ...
            SanPham sp = SanPhamDao2.findById(maSanPham);
            if(sp == null){
                ...
                jTextField_SoLuong.setText(sp.getSoLuong()+"");
//Chọn hàng trong bảng: 
    ...
    private void jButton_XoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_XoaActionPerformed
        ...
        try {
            if(SanPhamDao2.deleteById(jTextField_MaBalo.getText()+"_"+jTextField_SoThuTu.getText())){
                Balo balo  = BaloDao2.findById(jTextField_MaBalo.getText());
                int soThuTu = balo.getSoThuTu();
                jButton_TaoMoiActionPerformed(evt);
                jTextField_SoThuTu.setText(soThuTu+"");
    ...
    private void jButton_CapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_CapNhatActionPerformed
        ...
        try {
            ...
            sp.setSoLuong(Integer.parseInt(jTextField_SoLuong.getText()));
            sp.setMa(jTextField_MaBalo.getText()+"_"+jTextField_SoThuTu.getText());
            if(SanPhamDao2.UpdateSanPham1(sp)){
    ...
    private void jButton_OpenFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_OpenFileActionPerformed
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                Balo balo = OpenFile.docTepBalo2(filePath,jTextField_MaBalo.getText());
                ...
                int n = BaloDao2.findById(maBalo).getSoThuTu();
                List<SanPham> sanPhams = balo.getDanhSachSanPham();
                for(SanPham sp : sanPhams){
                    jTextField_SoThuTu.setText(n+"");
                    String ma = sp.getMa();
                    sp.setMa(ma+n);
                    SanPhamDao2.insertSanPham(sp, maBalo);
                    n++;
                }
                BaloDao2.updateSttBalo(maBalo, n);
                jTextField_TrongLuongBalo.setText(balo.getTrongLuongBalo()+"");
                //Load lại bảng, để thấy dữ liệu vừa mới lên.
                loadDataToTable();
            } catch (IOException ex) {
                Logger.getLogger(Balo2Form.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        ...
        if (evt.getClickCount() == 2) {
            try {
                ...
                if (row >= 0) {
                    ...
                    // Hiển thị dialog
                    updateFormDialog = new UpdateFormDialog2(this.mainView, true, this);
    ...
    private void jButton_ChayChuongTrinhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ChayChuongTrinhActionPerformed
        ...
        List<SanPham> sanPhams = SanPhamDao2.findByIdBalo(jTextField_MaBalo.getText());
        ...
        BaloDao2.updateBalo(balo.getTrongLuongBalo(), balo.getMa());
        ...
        switch (giaiThuat) {
            case "Tham ăn":
                ThamAn.RunThamAn2(balo);
                i=1;
                break;
            case "Nhánh cận":
                NhanhCan.runNhanhCan2(balo);
                i=2;
                break;
            case "Quy hoạch động":
                QuyHoachDong.runQuyHoachDong2(balo);
                i=3;
                break;
        }
        ...
        for (SanPham sp : balo.getDanhSachSanPham()) {
            SanPhamDao2.UpdateSanPham(sp);
            if(i==1){
                PhuongAnDao2.updateThamAn(sp.getMa(), sp.getPhuongAn());
            } else if(i==2){
                PhuongAnDao2.updateNhanhCan(sp.getMa(), sp.getPhuongAn());
            } else{
                PhuongAnDao2.updateQuyHoachDong(sp.getMa(), sp.getPhuongAn());
            }
    ...
    private void jButton_LocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LocActionPerformed
        if(countFilter==0){
            try {
                List<SanPham> list = SanPhamDao2.LocSanPham(jTextField_MaBalo.getText());
                tblModel.setRowCount(0);
                for(SanPham sp : list){
                    tblModel.addRow(new Object[]{
                        sp.getMa().split("_")[sp.getMa().split("_").length - 1],
            ...
            try {
                SanPhamDao2 dao = new SanPhamDao2();
...
//==========================================================================================================
    ...
    private void jButton_ExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ExportActionPerformed
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            XuatFile2.exportToTxt(SanPhamDao2.findByIdBalo(jTextField_MaBalo.getText())
                    ,PhuongAnDao2.findThamAn(jTextField_MaBalo.getText()+"%")
                    ,PhuongAnDao2.findNhanhCan(jTextField_MaBalo.getText()+"%") 
                    ,PhuongAnDao2.findQuyHoachDong(jTextField_MaBalo.getText()+"%")
                    ,filePath
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        // TODO add your handling code here:
        CompareFormDialog2 conCompareFormDialog = new CompareFormDialog2(mainView, true, this);
