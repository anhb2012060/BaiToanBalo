 ...
 * @author OS
 */
public class UpdateFormDialog3 extends javax.swing.JDialog {

    private Balo3Form balo3Form;

    // Trong UpdateFormDialog
    public UpdateFormDialog3(java.awt.Frame parent, boolean modal, Balo3Form balo3Form) {
        super(parent, modal);
        initComponents();
        this.balo3Form = balo3Form;
        UpdateSanPhamForm();
    }
    ...
    private void initComponents() {
        ...
        jPanel_thongTinSanPhamLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_thongTinSanPhamLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_thongTinSanPhamLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jButton_CapNhat, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)
    ...
    private void jButton_CapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_CapNhatActionPerformed
        try {
            ...
            if(SanPhamDao3.UpdateSanPham1(sp)){
                ...
                balo3Form.loadDataToTable(); // Gọi phương thức loadDataToTable để cập nhật dữ liệu trong bảng
                balo3Form.taoMoiForm();
